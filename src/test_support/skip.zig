...
pub const Blocker = enum {
    ...
    /// cycle 54b.
    @"D-194",
    /// 10.G x86_64 i31 JIT emit (ref.i31 / i31.get_s / i31.get_u).
    /// arm64 landed first (this cycle); x86_64 needs SAR/OR-imm8
    /// encoders + op-files. Subsumed by the GC-on-JIT bundle (D-211).
    @"D-211",
};
