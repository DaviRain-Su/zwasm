...
pub const op_tag: ZirOp = .throw;
pub const wasm_level: ?WasmLevel = .v3_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_throw,
    .lower = lower_throw,
    .interp = interp_throw,
};

fn validate_throw() collector.DispatchError!void {
    return error.NotMigrated;
}

fn lower_throw() collector.DispatchError!void {
    return error.NotMigrated;
}

fn interp_throw() collector.DispatchError!void {
    return error.NotMigrated;
}
