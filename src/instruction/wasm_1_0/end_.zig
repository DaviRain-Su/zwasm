...
pub const op_tag: ZirOp = .end;
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_end_,
    .lower = lower_end_,
    .interp = interp_end_,
};

fn validate_end_() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_end_() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_end_() collector.DispatchError!void {
    return error.NotMigrated;
}
