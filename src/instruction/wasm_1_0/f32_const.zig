...
pub const op_tag: ZirOp = .@"f32.const";
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_f32_const,
    .lower = lower_f32_const,
    .interp = interp_f32_const,
};

fn validate_f32_const() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_f32_const() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_f32_const() collector.DispatchError!void {
    return error.NotMigrated;
}
