...
pub const op_tag: ZirOp = .@"i32.const";
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_i32_const,
    .lower = lower_i32_const,
    .interp = interp_i32_const,
};

fn validate_i32_const() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_i32_const() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_i32_const() collector.DispatchError!void {
    return error.NotMigrated;
}
