...
pub const op_tag: ZirOp = .br_table;
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_br_table,
    .lower = lower_br_table,
    .interp = interp_br_table,
};

fn validate_br_table() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_br_table() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_br_table() collector.DispatchError!void {
    return error.NotMigrated;
}
