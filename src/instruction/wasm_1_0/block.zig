...
fn validate_block() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_block() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_block() collector.DispatchError!void {
    return error.NotMigrated;
}
