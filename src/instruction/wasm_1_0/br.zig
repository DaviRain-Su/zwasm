...
pub const op_tag: ZirOp = .br;
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_br,
    .lower = lower_br,
    .interp = interp_br,
};

fn validate_br() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_br() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_br() collector.DispatchError!void {
    return error.NotMigrated;
}
