//! `i32.and` — Wasm 1.0 §5.4.5 numeric op.
//!
...
pub const op_tag: ZirOp = .@"i32.and";
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_i32_and,
    .lower = lower_i32_and,
    .interp = interp_i32_and,
};

fn validate_i32_and() collector.DispatchError!void {
    return error.NotMigrated;
}

fn lower_i32_and() collector.DispatchError!void {
    return error.NotMigrated;
}

fn interp_i32_and() collector.DispatchError!void {
    return error.NotMigrated;
}
