...
pub const op_tag: ZirOp = .@"f64.const";
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_f64_const,
    .lower = lower_f64_const,
    .interp = interp_f64_const,
};

fn validate_f64_const() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_f64_const() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_f64_const() collector.DispatchError!void {
    return error.NotMigrated;
}
