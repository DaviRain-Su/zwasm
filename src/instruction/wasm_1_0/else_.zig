...
pub const op_tag: ZirOp = .@"else";
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_else_,
    .lower = lower_else_,
    .interp = interp_else_,
};

fn validate_else_() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_else_() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_else_() collector.DispatchError!void {
    return error.NotMigrated;
}
