//! `i32.or` — Wasm 1.0 §5.4.5 numeric op.
//!
...
pub const op_tag: ZirOp = .@"i32.or";
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_i32_or,
    .lower = lower_i32_or,
    .interp = interp_i32_or,
};

fn validate_i32_or() collector.DispatchError!void {
    return error.NotMigrated;
}

fn lower_i32_or() collector.DispatchError!void {
    return error.NotMigrated;
}

fn interp_i32_or() collector.DispatchError!void {
    return error.NotMigrated;
}
