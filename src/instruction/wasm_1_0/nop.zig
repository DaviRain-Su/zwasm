...
//! ADR-0074 + §9.12-B / B72 (nop meta backfill).
...
pub const op_tag: ZirOp = .nop;
pub const wasm_level: ?WasmLevel = .v1_0;
pub const wasi_level: ?WasiLevel = null;
pub const enable_features: []const Feature = &.{};

pub const handlers = .{
    .validate = validate_nop,
    .lower = lower_nop,
    .interp = interp_nop,
};

fn validate_nop() collector.DispatchError!void {
    return error.NotMigrated;
}
fn lower_nop() collector.DispatchError!void {
    return error.NotMigrated;
}
fn interp_nop() collector.DispatchError!void {
    return error.NotMigrated;
}
