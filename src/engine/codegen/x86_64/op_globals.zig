...
pub fn emitGlobalGet(
    ...
    switch (shape.vt) {
        ...
        .i64, .funcref, .externref, .i31ref, .anyref, .eqref, .structref, .arrayref => try emitI64GlobalGet(allocator, buf, alloc, pushed_vregs, next_vreg, spill_base_off, idx, shape.byte_off),
...
pub fn emitGlobalSet(
    ...
    switch (shape.vt) {
        ...
        .i64, .funcref, .externref, .i31ref, .anyref, .eqref, .structref, .arrayref => try emitI64GlobalSet(allocator, buf, alloc, pushed_vregs, spill_base_off, idx, shape.byte_off),
