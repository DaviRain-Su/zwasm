...
test "migratedOpCount tracks collected_ops length (50 after §9.12-B / B18 bitcount cohort)" {
    // Running tally: ALU 12 + cmp 20 + eqz/shift 12 + bitcount 6 = 50.
    try std.testing.expectEqual(@as(usize, 50), migratedOpCount());
}
