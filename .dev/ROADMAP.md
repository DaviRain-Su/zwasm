...
| 10.C9   | Phase 9 close 後始末 — §9.11 audit_scaffolding Phase-boundary pass + §9.x 17 行 SHA backfill + bench Phase 9 close baseline → `bench/results/history.yaml` + `phase9_close_master.md` Doc-state → ARCHIVED-IN-PLACE.                                                                                                                                                                                                                  | [ ]    |
| 10.F    | c_api scalar accessors (D-171/172/173) — wasm-c-api spec 標準 global/table/memory accessors を `src/api/instance.zig` に追加 (Phase F per `phase9_close_master.md` §5.3a).                                                                                                                                                                                                                                                       | [ ]    |
