...
|------------|--------------|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2026-05-04 | `6752ab0d` | initial   | Adopted; consolidated Q1-Q10 design dialogue.                                                                                                                                                                                                                                                                                    |
| 2026-05-05 | `3aaca6bf` | gap       | Amended by ADR-0024 (post-implementation): the §3 reference-table row for `api/lib_export.zig` is removed, `main.zig` moves to `src/cli/main.zig`, and a new `src/zwasm.zig` library root is added. ADR-0024 explains why the original ADR's directory shape couldn't serve as a Zig 0.16 lib `Module.root_source_file` directly. |
