...
Campaign: 1626 mods / 122 funcs / **0 mismatch, 0 crash** — interp+JIT agree. **GATING @0a93dde8e** (fatal on
any future divergence; seed smoke is a "harness runs" check like the loader, the campaign is the real net).
