...
| R10 | CW v2 dogfooding at ADR-0109 Closed gate hits a fundamental shape problem | spike-needed | After J.close, ADR-0109 Status stays `Closed (implemented; dogfooding gate at next CW v2 sync)` until CW v2 confirms; if rejected, file ADR-0118 superseding | post-J.close |
